      ...
      child: Stack(
        children: [
          SingleChildScrollView(
            ...
            child: BlocBuilder<BillManagerCubit, BillManagerState>(
                    ...
                    FilterModalTile(
                      ...
                      child: Wrap(
                        ...
                        children: FetchAPIOrdering.values.map(
                          (e) {
                            final selected = e == cubit.orderingFilter;
                            return FilterChip(
                              label: Text(FetchAPIOrdering.displayValueMap[e]!),
                              selected: selected,
                              onSelected: (_) {
                    ...
                    FilterModalTile(
                      ...
                      child: Wrap(
                        ...
                        children: BillType.values.sublist(1).map((e) {
                          final selected = cubit.typeFilter.contains(e);
                          return FilterChip(
                            ...
                            labelStyle: themeData.chipTheme.labelStyle.copyWith(
                                color: !selected
                                    ? themeData.colorScheme.disabledChipText
                                    : null),
                          );
                        }).toList(),
                      ),
                    ...
                    FilterModalTile(
                      ...
                      child: Wrap(
                        ...
                        children: BillStatus.values.map((e) {
                          final selected = e == cubit.statusFilter;
                          return FilterChip(
