            ...
            child: isLoading
                ...
                : Column(
                    children: [
                      ...
                      Text(
                        'Credit Transactions were performed',
                        style: TextStyle(
                          color: colorScheme.primary,
                          fontSize: 12,
                        ),
              ...
              child: isLoading
                  ...
                  : Column(
                      children: [
                        ...
                        Text(
                          data!.creditTransactionAmount.toStringAsFixed(2),
                          style: TextStyle(
                            fontSize: 45,
                            fontWeight: FontWeight.bold,
                            color: colorScheme.primary,
                        ...
                        const SizedBox(height: 15),
                        Text(
                          'of amount was received from users',
                          style: TextStyle(
                            color: colorScheme.primary,
                            fontSize: 12,
                          ),
